...
namespace EngineCore::UI {
	...
	StyleAttribute::StyleAttribute(std::string name, std::string desc, std::string faBack, std::vector<std::string> inputs, std::function<StyleValue(const ElementBase& element, const StyleAttribute*, const std::string&)> p)
