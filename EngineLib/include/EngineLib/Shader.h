...
namespace EngineCore {
    ...
    public:
        ...
        */
         ...
         */
        void SetMatrix2(const std::string& name, const float* data) const;
         ...
         */
        void SetMatrix3(const std::string& name, const float* data) const;
         ...
         */
        void SetMatrix4(const std::string& name, const float* data) const;
         ...
         */
        void SetMatrix2x3(const std::string& name, const float* data) const;
         ...
         * @param data Pointer to 6 float values in column-major order.
         */
        void SetMatrix3x2(const std::string& name, const float* data) const;
         ...
         */
        void SetMatrix2x4(const std::string& name, const float* data) const;
         ...
         * @param data Pointer to 8 float values in column-major order.
         */
        void SetMatrix4x2(const std::string& name, const float* data) const;
         ...
         */
        void SetMatrix3x4(const std::string& name, const float* data) const;
    ...
    private:
        ...
        ShaderID m_ID = ShaderID(ENGINE_INVALID_ID);
        ...
        */
        bool CanSetValue(const std::string& funcName, const std::string& paramName) const;
    };
