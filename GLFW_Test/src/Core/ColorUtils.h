...
public:
    ...
    */
     ...
     */
    static String RGBToHex(const Vector3& color, bool withPrefix = true);
    ...
    * @return Hexadecimal color string representing the RGB input.
    */
    static String RGBToHex(float r, float g, float b, bool withPrefix = true);
    ...
    * @return Hexadecimal color string representing the RGB input.
    */
    static String HSVToHex(const Vector3& color, bool withPrefix = true);
    ...
    * @return Hexadecimal color string representing the RGB input.
    */
    static String HSVToHex(float r, float g, float b, bool withPrefix = true);
    ...
    */
    static Vector3 HexToRGB(const String& hex);
    ...
    */
    static Vector4 HexToRGBA(const String& hex);

private:
    static String RGBToHexImpl(int r, int g, int b, bool withPrefix = true);
};