...
// Helper
inline ImGuiTableFlags TableFixFlags(ImGuiTableFlags flags, EngineWindow* outer_window)
{
...
{
    ImGuiContext& g = *GImGui;
    EngineWindow* outer_window = GetCurrentWindow();
    ...
    EngineWindow* inner_window = table->InnerWindow;
...
void    ImGui::EndTable()
{
    ...
    EngineWindow* inner_window = table->InnerWindow;
    EngineWindow* outer_window = table->OuterWindow;
...
{
    EngineWindow* window = table->InnerWindow;
...
void ImGui::SetWindowClipRectBeforeSetChannel(EngineWindow* window, const ImRect& clip_rect)
{
...
{
    EngineWindow* window = GetCurrentWindowRead();
...
ImGuiOldColumns* ImGui::FindOrCreateColumns(EngineWindow* window, ImGuiID id)
{
